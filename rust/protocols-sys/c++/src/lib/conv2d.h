...
/* Inverts the preprocessing of an image - used for extracting input MAC share */
u64** conv_preprocess_invert(vector<Ciphertext> &r_mac_ct, const Metadata &data, Decryptor &decryptor, BatchEncoder &batch_encoder);
