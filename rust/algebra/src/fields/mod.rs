...
pub trait PrimeField: Field + FromStr {
    ...
    /// Returns the characteristic of the prime field.
...
use crate::biginteger::{BigInteger256, BigInteger384, BigInteger64};

impl_field_into_bigint!(Fp64, BigInteger64, Fp64Parameters);
